...
# Poprawne kolumny
baza['Drużyna_norm'] = baza['Drużyna'].apply(normalize)
baza['Przeciwnik_norm'] = baza['Przeciwnik'].apply(normalize)
...
baza['Klucz'] = baza['Kolejka'].astype(str) + "_" + baza['Drużyna_norm'] + "_" + baza['Przeciwnik_norm'] + "_" + baza['Typ']
...
# Czyścimy
baza = baza.drop(columns=['Drużyna_norm', 'Przeciwnik_norm', 'Klucz'])
